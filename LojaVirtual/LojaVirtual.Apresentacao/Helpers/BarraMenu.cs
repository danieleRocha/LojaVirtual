...
namespace LojaVirtual.Apresentacao.Helpers
{
    public class BarraMenu
    {
        public static MvcHtmlString Administrador(string titulo)
        {
            ...
            html = String.Format("{0}                    <li><a tabindex=\"-1\" href=\"/Turma/Importar/\">Listar Mercadorias</a></li>", html);
            ...
            html = String.Format("{0}                    <li><a tabindex=\"-1\" href=\"/Curso/Listar/\">Listar Categorias</a></li>", html);
            html = String.Format("{0}                </ul>", html);
            html = String.Format("{0}            </li>", html);
